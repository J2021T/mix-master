...
// //     var liqourName = liqourBtnEL.value.trim();

// //     getCoctail(liqourName);
// // };

// // // liqour button submit listener
// // liqourBtnEl.addEventListener('submit', formSubmitHandler);

// var getCocktail = function(liqourName) {
//     fetch('https://www.thecocktaildb.com/api/json/v1/1/filter.php?i=Vodka&apiid=1').then(function(response) {
...
//             var drinkNameEl = data.drinks[ranDrink].strDrink;
